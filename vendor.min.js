/* vendor.min.js — tự host, gộp từ 4 thư viện gốc, GHIM ĐÚNG PHIÊN BẢN:
   gsap 3.13.0 (core) + ScrollTrigger 3.13.0 + SplitText 3.13.0 + Lenis 1.1.18
   Nguồn gốc: cdnjs.cloudflare.com (gsap/ScrollTrigger/SplitText) và
   cdn.jsdelivr.net (Lenis) — gộp lại để bớt 2 origin CDN ngoài, phục vụ
   CSP script-src 'self' và giảm số lần bắt tay DNS/TLS lúc tải trang.
   Không sửa nội dung từng thư viện, chỉ nối lại nguyên văn. */
